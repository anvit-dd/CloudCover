    ...
    <div className="flex w-[100vw] h-24 bg-slate-50 p-4">
      ...
      <div className="flex-1 items-center p-2">
        <div className="w-[50%] h-[100%] bg-slate-200 p-2 rounded-full items-center py-4 px-4 flex">
          ...
          <input type="text" placeholder="Search Here" onChange={(qry)=>{send_Query(qry.target.value)}} className="flex-1 h-[125%] bg-transparent mx-1 p-2 focus:outline-none text-bold text-black text-lg" />
      ...
      <div className="flex items-center">
        ...
        <div className='rounded-full hover:bg-slate-300 p-4'>
