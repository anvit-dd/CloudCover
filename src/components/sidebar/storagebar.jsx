...
const StorageBar = ({folder_name}) => {
    ...
    return (
        <div>
            ...
            <p className='text-center mt-2 text-gray-700 font-medium text-xs lg:text-base md:text-sm'>{formatBytes(storageUsed)} of 1 GB used</p>
        </div>
    )
}
